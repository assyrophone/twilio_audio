...
public class VoiceActivity extends AppCompatActivity {
    ...
    private static final String identity = "ninos";
    /*
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "https://test.fibler.com/v1/twilio/token";
    ...
    private void retrieveAccessToken() {
        Log.e("ninos--=",TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity+"&devicetype=2");
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity+"&devicetype=2")
                .asString()
